...
module.exports = (
    ...
    if (numMedia > 0) {
        ...
        if (multiSearchOr(Body, ["lunch"]) || multiSearchOr(Body, ["dinner"]) || multiSearchOr(Body, ["breakfast"])) {
            lib[`${context.service.identifier}.messaging.food`]({
                tel: from.number,
                body: Body,
                from: from,
                to: to
        ...
        } else if (multiSearchOr(Body, ["campus", "connector"]) ||
            multiSearchOr(Body, ["tracs"]) || multiSearchOr(Body, ["packer", "express"]) ||
             multiSearchOr(Body, ["mountaintop", "express"]) || multiSearchOr(Body, ["bus"])) {
            lib[`${context.service.identifier}.messaging.bus`]({
                tel: from.number,
                body: Body,
                from: from,
                to: to
        ...
        } else if (multiSearchOr(Body, ["library"]) || multiSearchOr(Body, ["libraries"])) {
            lib[`${context.service.identifier}.messaging.library`]({
                tel: from.number,
                body: Body,
                from: from,
                to: to
        ...
        } else if (multiSearchOr(Body, ["gym"])) {
            lib[`${context.service.identifier}.messaging.gym`]({
                tel: from.number,
                body: Body,
                from: from,
                to: to
